    ...
    <>
      <div className="lg:min-h-[89vh] flex w-full">
        ...
        <div className="min-h-[95vh] mt-5 lg:mt-0 lg:h-full lg:min-h-[88vh] pb-10 flex-1 flex justify-center items-center">
          {/* Login Form Div */}
          <div className="bg-white dark:bg-darkgrey dark:text-darkmodetext border-[1px] w-[85%] -translate-y-5 md:-translate-y-0 px-8 md:w-[65%] mt-5 md:mt-14 lg:mt-5 p-5 md:px-20 shadow-xl rounded-2xl pb-10">
            {/* Title */}
