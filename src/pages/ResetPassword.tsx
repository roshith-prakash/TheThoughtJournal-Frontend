...
import { PasswordInput, CTAButton } from "@/components";
...
export default function ResetPassword() {
  ...
  return (
    <div>
      <div className="bg-white mx-auto mt-14 dark:border-1 dark:border-white/25  max-w-xl dark:bg-darkgrey dark:text-darkmodetext border-darkbg/25 border-1 px-8 lg:max-w-lg p-5 md:px-10 shadow-lg rounded-2xl pb-10">
        {/* Title */}
